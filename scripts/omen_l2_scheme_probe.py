...
# trading/omen_layers.py ([2a53f971]): a probe-local encoder is one the live
# path cannot use, and two copies is how the margin=0 fallback drifts apart.
# Re-exported under this module's name so callers and tests written against
# the probe keep working.
