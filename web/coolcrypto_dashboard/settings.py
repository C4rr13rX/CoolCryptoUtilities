...
LANGUAGE_SELECT_OPTIONS = [
    {"code": "en", "label": "English", "native": "English", "flag": "us", "flag_emoji": "🇺🇸"},
    {"code": "es", "label": "Spanish", "native": "Español", "flag": "mx", "flag_emoji": "🇲🇽"},
    {"code": "fr", "label": "French", "native": "Français", "flag": "fr", "flag_emoji": "🇫🇷"},
    {"code": "de", "label": "German", "native": "Deutsch", "flag": "de", "flag_emoji": "🇩🇪"},
    {"code": "it", "label": "Italian", "native": "Italiano", "flag": "it", "flag_emoji": "🇮🇹"},
    {"code": "pt", "label": "Portuguese", "native": "Português", "flag": "br", "flag_emoji": "🇧🇷"},
    {"code": "pt-br", "label": "Portuguese (Brazil)", "native": "Português (Brasil)", "flag": "br", "flag_emoji": "🇧🇷"},
    {"code": "nl", "label": "Dutch", "native": "Nederlands", "flag": "nl", "flag_emoji": "🇳🇱"},
    {"code": "sv", "label": "Swedish", "native": "Svenska", "flag": "se", "flag_emoji": "🇸🇪"},
    {"code": "no", "label": "Norwegian", "native": "Norsk", "flag": "no", "flag_emoji": "🇳🇴"},
    {"code": "da", "label": "Danish", "native": "Dansk", "flag": "dk", "flag_emoji": "🇩🇰"},
    {"code": "fi", "label": "Finnish", "native": "Suomi", "flag": "fi", "flag_emoji": "🇫🇮"},
    {"code": "pl", "label": "Polish", "native": "Polski", "flag": "pl", "flag_emoji": "🇵🇱"},
    {"code": "cs", "label": "Czech", "native": "Čeština", "flag": "cz", "flag_emoji": "🇨🇿"},
    {"code": "sk", "label": "Slovak", "native": "Slovenčina", "flag": "sk", "flag_emoji": "🇸🇰"},
    {"code": "hu", "label": "Hungarian", "native": "Magyar", "flag": "hu", "flag_emoji": "🇭🇺"},
    {"code": "ro", "label": "Romanian", "native": "Română", "flag": "ro", "flag_emoji": "🇷🇴"},
    {"code": "bg", "label": "Bulgarian", "native": "Български", "flag": "bg", "flag_emoji": "🇧🇬"},
    {"code": "el", "label": "Greek", "native": "Ελληνικά", "flag": "gr", "flag_emoji": "🇬🇷"},
    {"code": "tr", "label": "Turkish", "native": "Türkçe", "flag": "tr", "flag_emoji": "🇹🇷"},
    {"code": "ru", "label": "Russian", "native": "Русский", "flag": "ru", "flag_emoji": "🇷🇺"},
    {"code": "uk", "label": "Ukrainian", "native": "Українська", "flag": "ua", "flag_emoji": "🇺🇦"},
    {"code": "ar", "label": "Arabic", "native": "العربية", "flag": "eg", "flag_emoji": "🇪🇬"},
    {"code": "he", "label": "Hebrew", "native": "עברית", "flag": "il", "flag_emoji": "🇮🇱"},
    {"code": "fa", "label": "Persian", "native": "فارسی", "flag": "ir", "flag_emoji": "🇮🇷"},
    {"code": "hi", "label": "Hindi", "native": "हिन्दी", "flag": "in", "flag_emoji": "🇮🇳"},
    {"code": "bn", "label": "Bengali", "native": "বাংলা", "flag": "bd", "flag_emoji": "🇧🇩"},
    {"code": "ur", "label": "Urdu", "native": "اردو", "flag": "pk", "flag_emoji": "🇵🇰"},
    {"code": "ta", "label": "Tamil", "native": "தமிழ்", "flag": "in", "flag_emoji": "🇮🇳"},
    {"code": "te", "label": "Telugu", "native": "తెలుగు", "flag": "in", "flag_emoji": "🇮🇳"},
    {"code": "mr", "label": "Marathi", "native": "मराठी", "flag": "in", "flag_emoji": "🇮🇳"},
    {"code": "gu", "label": "Gujarati", "native": "ગુજરાતી", "flag": "in", "flag_emoji": "🇮🇳"},
    {"code": "pa", "label": "Punjabi", "native": "ਪੰਜਾਬੀ", "flag": "pk", "flag_emoji": "🇵🇰"},
    {"code": "vi", "label": "Vietnamese", "native": "Tiếng Việt", "flag": "vn", "flag_emoji": "🇻🇳"},
    {"code": "th", "label": "Thai", "native": "ไทย", "flag": "th", "flag_emoji": "🇹🇭"},
    {"code": "id", "label": "Indonesian", "native": "Bahasa Indonesia", "flag": "id", "flag_emoji": "🇮🇩"},
    {"code": "ms", "label": "Malay", "native": "Bahasa Melayu", "flag": "my", "flag_emoji": "🇲🇾"},
    {"code": "fil", "label": "Filipino", "native": "Filipino", "flag": "ph", "flag_emoji": "🇵🇭"},
    {"code": "ja", "label": "Japanese", "native": "日本語", "flag": "jp", "flag_emoji": "🇯🇵"},
    {"code": "ko", "label": "Korean", "native": "한국어", "flag": "kr", "flag_emoji": "🇰🇷"},
    {"code": "zh-hans", "label": "Chinese (Simplified)", "native": "简体中文", "flag": "cn", "flag_emoji": "🇨🇳"},
    {"code": "zh-hant", "label": "Chinese (Traditional)", "native": "繁體中文", "flag": "tw", "flag_emoji": "🇹🇼"},
]
