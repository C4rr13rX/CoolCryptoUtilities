...
class C0d3rWebRun(models.Model):
    ...
    wizard_brain_id = models.CharField(max_length=64, default="", blank=True)
    wizard_endpoint = models.URLField(max_length=500, default="", blank=True)
    wizard_chat_path = models.CharField(max_length=32, default="", blank=True)
