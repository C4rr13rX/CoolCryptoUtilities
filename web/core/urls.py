...
urlpatterns = [
    ...
    path("model-control/", views.ModelControlPageView.as_view(), name="model-control"),
    path("model-control", views.ModelControlPageView.as_view()),
    ...
    path("logs/", views.LogsPageView.as_view(), name="logs"),
    path("logs", views.LogsPageView.as_view()),
    path("wizard-chat/", views.WizardChatPageView.as_view(), name="wizard-chat"),
    ...
    path("api/codegraph/repositories/", views.CodeGraphRepositoryView.as_view(), name="codegraph-repositories"),
    path("api/codegraph/repositories/<str:repository_id>/", views.CodeGraphRepositoryDetailView.as_view(), name="codegraph-repository-detail"),
    path("api/codegraph/source/", views.CodeGraphSourceView.as_view(), name="codegraph-source"),
    path("api/c0d3r/run/", views.C0d3rRunView.as_view(), name="c0d3r-run"),
    path("api/c0d3r/run", views.C0d3rRunView.as_view()),
    path("api/c0d3r/runs/<uuid:run_id>/", views.C0d3rRunStatusView.as_view(), name="c0d3r-run-status"),
    path("api/c0d3r/runs/<uuid:run_id>", views.C0d3rRunStatusView.as_view()),
